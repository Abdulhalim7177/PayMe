                ...
                <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                    <ul class="navbar-nav u-header__navbar-nav">
                        ...
                        <li class="nav-item u-header__nav-item mr-6">
                            <a class="nav-link u-header__nav-link" href="login.html">Login</a>
                        </li>
                        <!-- End Login -->

                        <!-- Button -->
                        <li class="nav-item u-header__nav-item">
                            <a class="btn btn-sm btn-primary transition-3d-hover" href="signup.html" target="_blank">
                                Create account
                            </a>
                        </li>
                        <!-- End Button -->
            ...
            <div class="row justify-content-lg-between height-lg-100vh">
                ...
                <span class="d-none d-sm-block btn btn-lg btn-icon btn-white text-primary rounded-circle mb-4">
                  <span class="fas fa-credit-card btn-icon__inner"></span>
                        ...
                        <a class="btn btn-white transition-3d-hover" href="signup.html">
                            Create account
    ...
    <div class="bg-primary text-white text-center">
        ...
        <span class="h6 d-block d-lg-inline-block font-weight-light mb-lg-0">
          <span class="font-weight-semi-bold">PayMe</span> – is a one-stop solution to accept payments online
            ...
            <a class="btn btn-sm btn-white transition-3d-hover font-weight-normal ml-2" href="signup.html">Create
                account</a>
        </div>
    </div>
    <!-- End CTA Section -->
...
<footer class="container text-center space-2">
    ...
    <ul class="list-inline list-group-flush list-group-borderless">
        ...
        <li class="list-inline-item px-2">
            <a class="list-group-item-action" href="privacy.html">Privacy</a>
        </li>
        <li class="list-inline-item px-2">
            <a class="list-group-item-action" href="terms.html">Terms</a>
        </li>
    </ul>
    <!-- End List -->

    <!-- Copyright -->
    <p class="small text-muted mb-3">⚡️ A project by <a href="https://maxkostinevich.com" target="_blank">Max
        Kostinevich</a> &amp; <a href="https://laravel101.com" target="_blank">Laravel 101</a>
        ⚡️</p>
